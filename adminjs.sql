...
INSERT INTO `Sessions` VALUES ('66oEWFHHeiewM3uuIUTO8clr0RPlDvdW','2024-09-14 08:00:53','{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"secure\":true,\"httpOnly\":true,\"path\":\"/\"},\"adminUser\":{\"email\":\"admin@example.com\",\"role\":\"user\"}}','2024-09-13 08:00:11','2024-09-13 08:00:53'),('Aax0b28P9nr4ASCnGiAnEQaRzXdjP7Ye','2024-09-14 07:51:45','{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"secure\":true,\"httpOnly\":true,\"path\":\"/\"},\"adminUser\":{\"email\":\"admin@example.com\",\"role\":\"admin\"}}','2024-09-13 07:47:10','2024-09-13 07:51:45');
...
INSERT INTO `exercise_delay` VALUES (5,'2',1,'2024-09-07 14:00:00',30);
...
CREATE TABLE `microsoft_account` (
  ...
  PRIMARY KEY (`ID`),
  KEY `UserID` (`UserID`),
  CONSTRAINT `microsoft_account_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `user` (`ID`) ON DELETE CASCADE
...
INSERT INTO `microsoft_account` VALUES (1,'84abfbef-68d2-4e5a-bc0b-c6072b9b3e47','1234567@outlook.com','1234567','1234567',1);
...
-- Dump completed on 2024-09-13  8:03:50
